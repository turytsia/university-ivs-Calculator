...
# encoding: utf-8
import customtkinter, os, sys, platform, tkinter, re
...
buttonClearLast = customtkinter.CTkButton(master=app, text="CE",
                                          command=lambda: label_changer(label, small_label, "last"),
...
buttonOpenBracket = customtkinter.CTkButton(master=app, text="(",
                                            command=lambda: label_changer(label, small_label, "("),
                                            width=100, height=80, hover=True, text_color="#36b6ab", hover_color="grey",
                                            fg_color="transparent",
                                            font=("Arial", 40))
...
buttonCloseBracket = customtkinter.CTkButton(master=app, text=")",
                                             command=lambda: label_changer(label, small_label, ")"),
                                             width=100, height=80, hover=True, hover_color="grey", text_color="#36b6ab",
                                             fg_color="transparent",
                                             font=("Arial", 40))
...
buttonMultiply = customtkinter.CTkButton(master=app, text="*", command=lambda: label_changer(label, small_label, "*"),
                                         width=100, height=80, hover=True, text_color="#36b6ab", hover_color="grey",
                                         fg_color="transparent",
                                         font=("Arial", 40))
